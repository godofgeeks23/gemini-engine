  ...
  try {
    ...
    for (const part of response.response.candidates[0].content.parts) {
      ...
      if (part.text) {
        ...
        const outputFileName = `photo-${generateRandomString()}.png`;
...
async function main() {
  const prompt =
    "Hi, This is a picture of a boy. Can you also add a girl as his girlfriend in the picture?";
  // Load the image from the local file system
  const imagePath = "testimg2.png";
